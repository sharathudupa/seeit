...
//--------------------------------------------------------------------------------------------------------------
    ...
    $.extend($.ui.dialog.prototype, {
        ...
        restore: function() {
            ...
            self.uiDialog.removeClass('dialog-minimized')
        ...
        _updateMinimizedWidths: function() {
            var tw = this.uiDialog.parent().width();
            var nb = $('.dialog-minimized:visible').size();
            var w = Math.min((tw - 2 * 10 - (nb -1) * 5)/nb, 250);
            var left = 10;
            $('.dialog-minimized:visible').each(function() {
              $(this).width(w);
              $(this).css('left', left);
              left += w+5;
            });
        ...
        minimize: function() { 
            ...
            this.uiDialog.addClass('dialog-minimized');
            this.uiDialog.css( {
              position: 'absolute',
              left: 10,
              width: 250,
        ...
        maximize: function() { 
            ...
            var newHeight = $(window).height()-11;
            var newWidth = $(window).width()-11;
            self.uiDialog.animate({top:$(document).scrollTop(), left: 1, width:newWidth, height:newHeight},200)            
